                ...
                <div>
                    <div>
                        ...
                        <div>
                            ...
                            <p>{gameDetails.genre?.map(gen => (gen.name ? gen.name : gen)).join(' | ')}</p>
                <div><img src={gameDetails.image ? gameDetails.image : "No image"} alt={`details.name}'s`} width='600px' height='auto'/></div>
